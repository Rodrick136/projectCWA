                ...
                <div class="logo">
                 ...
                 <div class="headerright">                 
                   <?php if ( ! dynamic_sidebar('sidebar-header')): ?>
                    ...
                    <span class="headeremail"><a href="mailto:<?php echo sanitize_email(get_theme_mod('head_email','info@buildpress.com')); ?>"><?php echo esc_attr(get_theme_mod('head_email','info@buildpress.com')); ?></a></span>
                    <?php } ?>
                    <div class="clear"></div>
                    </div>
                    ...
                    <span class="headeremail"><?php echo esc_attr( get_theme_mod('head_citycountry', 'Western Australia', 'skt-construction' )); ?></span>
                    <?php } ?>
                    <div class="clear"></div>
                    </div>
                  <?php endif; ?>  
